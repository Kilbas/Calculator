...
public class Calculator {
    ...
    public static String calc(String input) {
        ...
        if (str.length != 3) {
            throw new RuntimeException("Формат математической операции не удовлетворяет заданию, " + "необходимы два операнда и один оператор");
        }
        ...
        if (!actionList.contains(action)) {
            throw new RuntimeException("Формат математической операции не удовлетворяет заданию, " + "необходим один оператор");
        }

        if (arabianNumbers.contains(num1) && arabianNumbers.contains(num2)) {
            return countArabian(num1, action, num2);
        } else if (romanNumbers.contains(num1) && romanNumbers.contains(num2)) {
